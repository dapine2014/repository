...
@Slf4j
@Component
public class PostgresConnectorExecutor implements RepositoryConnectorExecutor {
    ...
    public Object execute(RepositoryOperationDto operation, Map<String, String> config) {
        ...
        return switch (method) {
            ...
            default -> throw new IllegalArgumentException("Unsupported method for postgres: " + method);
        };
    }
    ...
    private Map<String, Object> save(RepositoryOperationDto operation, Map<String, String> config) {
        ...
        // Detectar la columna PK: preferimos "id", luego "_id", luego la primera columna
        ...
        String sql = "INSERT INTO " + quote(table) + " (" + colList + ") VALUES (" + placeholders + ")"
                + " ON CONFLICT (" + quote(pkCol) + ") DO UPDATE SET " + updateSet;
    ...
    // Comilla identificadores para evitar conflictos con palabras reservadas
